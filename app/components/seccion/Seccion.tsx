...
export default function Seccion() {
  return (
    ...
    <div className="grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8">
        <img src="https://http2.mlstatic.com/D_NQ_NP_2X_825890-MLA54124091906_032023-F.webp" alt="Walnut card tray with white powder coated steel divider and 3 punchout holes." className="rounded-lg bg-gray-100"/>
        <img src="https://http2.mlstatic.com/D_NQ_NP_2X_754488-MLA54923442213_042023-F.webp" alt="Top down view of walnut card tray with embedded magnets and card groove." className="rounded-lg bg-gray-100"/>
        <img src="https://http2.mlstatic.com/D_NQ_NP_2X_792045-MLA54923442215_042023-F.webp" alt="Side of walnut card tray with card groove and recessed card area." className="rounded-lg bg-gray-100"/>
        <img src="https://http2.mlstatic.com/D_NQ_NP_2X_653102-MLA54928474832_042023-F.webp" alt="Walnut card tray filled with cards and card angled in dedicated groove." className="rounded-lg bg-gray-100"/>
      </div>
